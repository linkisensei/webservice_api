...
/**
 * Event oauth_credentials_updated
 *
 * @package webservice_api
 */
class oauth_credentials_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event:oauth_credentials_updated', 'webservice_api');
    }
